<?php 
	...
	if (isset($_POST['save'])) {
		...
		$success_msg[] = 'produto atualizado!';
	...
	<div class="main-container">
		...
		<section class="post-editor">
			...
			<div class="box-container">
				...
				<div class="form-container">
					<form action="" method="post" enctype="multipart/form-data">
						...
						<div class="input-field">
							<label>estado do produto <sup>*</sup></label>
						...
						<div class="input-field">
							 ...
							 <?php if($fetch_post['image'] != ''){ ?>
							 	...
							 	<div class="flex-btn">
							 		<input type="submit" name="delete_image" class="btn" value="Apagar imagem">
							 		<a href="view_posts.php" class="btn" style="width:49%; text-align: center; height: 3rem; margin-top: .7rem;">Voltar</a>
							 	</div>
							<?php } ?>
						</div>
						<div class="flex-btn">
							<input type="submit" name="save" value="Guardar" class="btn">
							<input type="submit" name="delete_post" value="Eliminar" class="btn">
						</div>
					</form>
				</div>
				<?php 
				...
				<br><br>
				<div class="flex-btn">
					<a href="view_posts.php" class="btn">ver produto</a>
					<a href="add_posts.php" class="btn">adicionar produto</a>
				</div>
				<?php } ?>
			</div>
