			...
			<div class="box-container">
				...
				<form action="" method="post" class="box">
					...
					<div class="flex-btn">
						...
						<button type="submit" name="delete" class="btn" onclick="return confirm('Apagar este produto');">Eliminar</button>
						<a href="view_posts.php?post_id=<?= $fetch_post['id']; ?>" class="btn">Voltar</a>
					</div>
				</form>
				<?php 
						}
						...
						echo '
							<div class="empty">
								<p>nenhum produto adicionado ainda <br><a href="add_posts.php" class="btn" style="margin-top: 1.5rem;">Adicionar produto</a></p>
							</div>
						';
					}
				?>
